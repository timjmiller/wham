...
<figure class="video_container">
  <iframe width="560" height="315" src="https://www.youtube.com/embed/o8vJvbIaOdE" frameborder="0" allowfullscreen="true" data-external="1" class="embed-responsive-item"> </iframe>
</figure>
</div>
```

[//]: # (
An explanatory video for an audience with a wide range of modeling experience was recorded by Jon Deroba in March 2026:
```{=html}
<div style="text-align: center;">
<figure class="video_container">
  <iframe width="560" height="315"  src='//players.brightcove.net/659677166001/4b3c8a9e-7bf7-43dd-b693-2614cc1ed6b7_default/index.html?videoId=6386714596112' allowfullscreen="true" data-external-"1" class="embed-responsive-item" frameborder="0"></iframe>
</iframe>
</figure>
</div>
```)
...
- Miller, T. J., Curti, K. L., Hansell, A. C. 2025. Space for WHAM: a multi-region, multi-stock generalization of the Woods Hole Assessment Model with an application to black sea bass. Canadian Journal of Fisheries and Aquatic Sciences 82:1-26. doi: [10.1139/cjfas-2025-0097](https://doi.org/10.1139/cjfas-2025-0097).
...
******************
<img src="https://raw.githubusercontent.com/nmfs-general-modeling-tools/nmfspalette/main/man/figures/noaa-fisheries-rgb-2line-horizontal-small.png" width="25%" alt="NOAA Fisheries">
