...
#' One-step-ahead residuals will be calculated for all but the last three options when \code{do.osa=TRUE} (Nielsen et al. in prep.). An age composition model needs
