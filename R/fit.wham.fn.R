...
#'   }
#' @param n.newton integer, number of additional Newton steps after optimization. Passed to \code{\link{fit.tmb.fn}}. Default = \code{3}.
...
#' @export
#'
#' @seealso \code{\link{fit.tmb.fn}}, \code{\link{retro.fn}}
#'
#' @examples
#' \dontrun{
#' data("SNEMA_ytl") # load SNEMA yellowtail flounder data and parameter settings
#' mod = fit.wham.fn(input) # using default values
#' }
