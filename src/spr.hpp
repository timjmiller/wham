...
array<Type> get_eq_SAA(int y, vector<int> spawn_seasons, vector<int> fleet_regions, array<int> can_move, 
  vector<int> mig_type, matrix<Type> fracyr_SSB, array<Type> FAA, array<Type> log_M_base, array<Type> mu, array<Type> L, 
  ...
  */
  ...
  int n_stocks = log_M_base.size(0);
  ...
  for(int s = 0; s < n_stocks; s++) {
    ...
    for(int a = 0; a < n_ages-1; a++) {
      ...
      S_ya = S_ya * get_S(P_ya); //accumulate for next age
...
array<Type> get_SPR_0(int y, vector<int> spawn_seasons, array<int> can_move, 
  vector<int> mig_type, matrix<Type> fracyr_SSB, array<Type> log_M_base, array<Type> mu, array<Type> L, 
  array<Type> mature, array<Type> waa, vector<int> waa_pointer_ssb, vector<Type> fracyr_seasons, int age_specific, int small_dim){
  /* 
...
template <class Type>
array<Type> get_YPR(int y, int n_seasons, vector<int> fleet_regions, array<int> can_move, 
  vector<int> mig_type, array<Type> FAA, array<Type> log_M_base, array<Type> mu, array<Type> L, array<Type> waa, 
