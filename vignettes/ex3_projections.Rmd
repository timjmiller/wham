...
Here we assume you already have `wham` installed. If not, see the [Introduction](https://timjmiller.github.io/wham/). This is the 3rd `wham` example, which builds off model `m6` from [example 2](https://timjmiller.github.io/wham/articles/ex2_CPI_recruitment.html):
...
Setup model `m6` from [example 2](https://timjmiller.github.io/wham/articles/ex2_CPI_recruitment.html):
