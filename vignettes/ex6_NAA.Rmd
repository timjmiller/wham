...
This is the 6th WHAM example, which blends aspects from [Ex 1](https://timjmiller.github.io/wham/articles/ex1_SNEMA_yellowtail_flounder.html), [Ex 2](https://timjmiller.github.io/wham/articles/ex2_CPI_recruitment_SNEMA_yellowtail.html), and [Ex 5](https://timjmiller.github.io/wham/articles/ex5_GSI_M.html). We assume you already have `wham` installed. If not, see the [Introduction](https://timjmiller.github.io/wham/). The simpler 1st example is available as a [R script](https://github.com/timjmiller/wham/blob/master/inst/example_scripts/ex1_SNEMA_yellowtail_flounder.R) and [vignette](https://timjmiller.github.io/wham/articles/ex1_SNEMA_yellowtail_flounder.html).

As in [example 1](https://timjmiller.github.io/wham/articles/ex1_SNEMA_yellowtail_flounder.html):
...
As in [example 2](https://timjmiller.github.io/wham/articles/ex2_CPI_recruitment_SNEMA_yellowtail.html):
...
We need the same ASAP data file as in [example 1](https://timjmiller.github.io/wham/articles/ex1_SNEMA_yellowtail_flounder.html), and the environmental covariate (Gulf Stream Index, GSI). Let's copy `ex1_SNEMAYT.dat` and `GSI.csv` to our analysis directory:
```{r eval=FALSE}
wham.dir <- find.package("wham")
...
- Models with a GSI-Recruitment link had less trend toward negative recruitment deviations, because the GSI effect on expected recruitment accounted for some of this trend.
