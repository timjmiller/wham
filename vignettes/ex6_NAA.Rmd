...
Models with a GSI-Recruitment link estimated higher observation error and more smoothing of the GSI than those without (compare confidence intervals for `m14`, left, to those for `m7`, right).
