...
This is the 6th WHAM example, which blends aspects from examples [1](https://timjmiller.github.io/wham/articles/ex1_SNEMA_yellowtail_flounder.html), [2](https://timjmiller.github.io/wham/articles/ex2_CPI_recruitment_SNEMA_yellowtail.html), and [5](https://timjmiller.github.io/wham/articles/ex5_GSI_M.html). We assume you already have `wham` installed. If not, see the [README](https://github.com/timjmiller/wham#installation-and-basic-use). The simpler 1st example is available as a [R script](https://github.com/timjmiller/wham/blob/master/inst/example_scripts/ex1_SNEMA_yellowtail_flounder.R) and [vignette](https://timjmiller.github.io/wham/articles/ex1_SNEMA_yellowtail_flounder.html).
