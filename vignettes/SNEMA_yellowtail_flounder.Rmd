...
vignette: >
  %\VignetteIndexEntry{WHAM example: Southern New England Mid-Atlantic Yellowtail Flounder}
...
cat("Maximum gradient component:",formatC(vign1_m1_conv$maxgr, format = "e", digits = 2),"\n")
cat("Max gradient parameter:",vign1_m1_conv$maxgr_par,"\n")
```
...
```{r echo=FALSE}
cat("The model appears converged: mod$opt$convergence == 0\n")
cat("Maximum gradient component:",formatC(vign1_m2_conv$maxgr, format = "e", digits = 2),"\n")
cat("Max gradient parameter:",vign1_m2_conv$maxgr_par,"\n")
```
...
```{r echo=FALSE}
cat("The model appears converged: mod$opt$convergence == 0\n")
cat("Maximum gradient component:",formatC(vign1_m3_conv$maxgr, format = "e", digits = 2),"\n")
cat("Max gradient parameter:",vign1_m3_conv$maxgr_par,"\n")
```
...
```{r echo=FALSE}
cat("The model appears converged: mod$opt$convergence == 0\n")
cat("Maximum gradient component:",formatC(vign1_m4_conv$maxgr, format = "e", digits = 2),"\n")
cat("Max gradient parameter:",vign1_m4_conv$maxgr_par,"\n")
```
...
## 4. Project the best model **(Not exactly, but this should be added to the model)**
