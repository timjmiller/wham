---
title: "WHAM example 5: Time-varying natural mortality with Gulf Stream Index effect on M"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{WHAM example 5: Time-varying natural mortality with Gulf Stream Index effect on M}
...
In the table, I have converted `na_sdrep` to `Pos def Hessian` and highlighted models for which this is true. Note that `mod$na_sdrep = FALSE` if `TMB::sdreport(mod)` successfully inverts the Hessian and produces SE estimates for all (fixed effect) parameters.
...
![Natural mortality by age (y-axis) and year (x-axis) for all models.](https://raw.githubusercontent.com/timjmiller/wham/mortality/vignettes/ex5_plots/MAA.png){ width=90% }
...
![Mohn's rho for numbers-at-age, m1.](https://raw.githubusercontent.com/timjmiller/wham/mortality/vignettes/ex5_plots/m1_NAA_retro_relative.png){ width=45% }![Mohn's rho for numbers-at-age, m8.](https://raw.githubusercontent.com/timjmiller/wham/mortality/vignettes/ex5_plots/m8_NAA_retro_relative.png){ width=45% }

![Mohn's rho for SSB, m1.](https://raw.githubusercontent.com/timjmiller/wham/mortality/vignettes/ex5_plots/m1_SSB_retro_relative.png){ width=45% }![Mohn's rho for SSB, m8.](https://raw.githubusercontent.com/timjmiller/wham/mortality/vignettes/ex5_plots/m8_SSB_retro_relative.png){ width=45% }

![Mohn's rho for F, m1.](https://raw.githubusercontent.com/timjmiller/wham/mortality/vignettes/ex5_plots/m1_Fbar_retro_relative.png){ width=45% }![Mohn's rho for F, m8.](https://raw.githubusercontent.com/timjmiller/wham/mortality/vignettes/ex5_plots/m8_Fbar_retro_relative.png){ width=45% }

It is also worth noting that, although the Hessian was not positive definite, model `m17` had the lowest retrospective pattern across all numbers-at-age, SSB, and F. `m17` left $M_a$ fixed at the values from the ASAP data file (as in `m1`) and estimated 2D AR1 deviations around these mean $M_a$. This is how $M$ was modeled in [Cadigan (2016)](https://www.nrcresearchpress.com/doi/10.1139/cjfas-2015-0047).

![Mohn's rho for SSB, m17.](https://raw.githubusercontent.com/timjmiller/wham/mortality/vignettes/ex5_plots/m17_SSB_retro_relative.png){ width=45% }![Mohn's rho for F, m17.](https://raw.githubusercontent.com/timjmiller/wham/mortality/vignettes/ex5_plots/m17_Fbar_retro_relative.png){ width=45% }

![Mohn's rho for recruitment, m17.](https://raw.githubusercontent.com/timjmiller/wham/mortality/vignettes/ex5_plots/m17_NAA_age1_retro_relative.png){ width=90% }

#### Stock status

Compared to `m1` (left), `m8` (right) estimated higher *M*, lower and more uncertain *F*, and higher SSB -- a much rosier picture of the stock status through time.

![Relative stock status, m1.](https://raw.githubusercontent.com/timjmiller/wham/mortality/vignettes/ex5_plots/m1_FSPR_relative.png){ width=45% }![Relative stock status, m8.](https://raw.githubusercontent.com/timjmiller/wham/mortality/vignettes/ex5_plots/m8_FSPR_relative.png){ width=45% }

Compared to `m1` (left), `m8` (right) estimated higher and more variable reference points, $F_{\%SPR}$ (top), and lower and more variable yield-per-recruit (bottom).

![Reference point variability, m1.](https://raw.githubusercontent.com/timjmiller/wham/mortality/vignettes/ex5_plots/m1_FSPR_annual_time.png){ width=45% }![Reference point variability, m8.](https://raw.githubusercontent.com/timjmiller/wham/mortality/vignettes/ex5_plots/m8_FSPR_annual_time.png){ width=45% }

In the final year (2011), `m8` estimated a lower probability of the stock being overfished (4% vs. 19%).

![Kobe status plot, m1.](https://raw.githubusercontent.com/timjmiller/wham/mortality/vignettes/ex5_plots/m1_Kobe_status.png){ width=45% }![Kobe status plot, m8.](https://raw.githubusercontent.com/timjmiller/wham/mortality/vignettes/ex5_plots/m8_Kobe_status.png){ width=45% }
