...
In the table below, I have converted `na_sdrep` to `Pos def Hessian` and highlighted models for which this is true. Note that `mod$na_sdrep = FALSE` if `TMB::sdreport(mod)` successfully inverts the Hessian and produces SE estimates for all (fixed effect) parameters.
