...
This is the 5th WHAM example, which builds off [example 2](https://github.com/timjmiller/wham/blob/master/inst/example_scripts/ex2_CPI_recruitment_SNEMA_yellowtail.R):
...
We need the same ASAP data file as in [example 2](https://github.com/timjmiller/wham/blob/master/inst/example_scripts/ex2_CPI_recruitment_SNEMA_yellowtail.R), and the environmental covariate (GSI). Let's copy `ex2_SNEMAYT.dat` and `GSI.csv` to our analysis directory:
```{r eval=FALSE}
wham.dir <- find.package("wham")
...
In the table, I have highlighted models which converged (see [`?stats::nlminb`](https://stat.ethz.ch/R-manual/R-patched/library/stats/html/nlminb.html)) and successfully inverted the Hessian to produce SE estimates for all (fixed effect) parameters (see [`?TMB::sdreport`](https://www.rdocumentation.org/packages/TMB/versions/1.7.16/topics/sdreport)). WHAM stores this information in `mod$na_sdrep` (should be `FALSE`), `mod$sdrep$pdHess` (should be `TRUE`), and `mod$opt$convergence` (should be `0`).
...
![Natural mortality by age (y-axis) and year (x-axis) for all models.](https://raw.githubusercontent.com/timjmiller/wham/naa/vignettes/ex5_plots/MAA.png){ width=90% }
...
![Mohn's rho for numbers-at-age, m1.](https://raw.githubusercontent.com/timjmiller/wham/naa/vignettes/ex5_plots/m1_NAA_retro_relative.png){ width=45% }![Mohn's rho for numbers-at-age, m8.](https://raw.githubusercontent.com/timjmiller/wham/naa/vignettes/ex5_plots/m8_NAA_retro_relative.png){ width=45% }

![Mohn's rho for SSB, m1.](https://raw.githubusercontent.com/timjmiller/wham/naa/vignettes/ex5_plots/m1_SSB_retro_relative.png){ width=45% }![Mohn's rho for SSB, m8.](https://raw.githubusercontent.com/timjmiller/wham/naa/vignettes/ex5_plots/m8_SSB_retro_relative.png){ width=45% }

![Mohn's rho for F, m1.](https://raw.githubusercontent.com/timjmiller/wham/naa/vignettes/ex5_plots/m1_Fbar_retro_relative.png){ width=45% }![Mohn's rho for F, m8.](https://raw.githubusercontent.com/timjmiller/wham/naa/vignettes/ex5_plots/m8_Fbar_retro_relative.png){ width=45% }
...
![Mohn's rho for SSB, m17.](https://raw.githubusercontent.com/timjmiller/wham/naa/vignettes/ex5_plots/m17_SSB_retro_relative.png){ width=45% }![Mohn's rho for F, m17.](https://raw.githubusercontent.com/timjmiller/wham/naa/vignettes/ex5_plots/m17_Fbar_retro_relative.png){ width=45% }

![Mohn's rho for recruitment, m17.](https://raw.githubusercontent.com/timjmiller/wham/naa/vignettes/ex5_plots/m17_NAA_age1_retro_relative.png){ width=45% }
...
![Relative stock status, m1.](https://raw.githubusercontent.com/timjmiller/wham/naa/vignettes/ex5_plots/m1_FSPR_relative.png){ width=31% }![Relative stock status, m8.](https://raw.githubusercontent.com/timjmiller/wham/naa/vignettes/ex5_plots/m8_FSPR_relative.png){ width=31% }![Relative stock status, m17.](https://raw.githubusercontent.com/timjmiller/wham/naa/vignettes/ex5_plots/m17_FSPR_relative.png){ width=31% }
...
![Reference point variability, m1.](https://raw.githubusercontent.com/timjmiller/wham/naa/vignettes/ex5_plots/m1_FSPR_annual_time.png){ width=31% }![Reference point variability, m8.](https://raw.githubusercontent.com/timjmiller/wham/naa/vignettes/ex5_plots/m8_FSPR_annual_time.png){ width=31% }![Reference point variability, m17.](https://raw.githubusercontent.com/timjmiller/wham/naa/vignettes/ex5_plots/m17_FSPR_annual_time.png){ width=31% }

In the final year (2011), `m8` estimated a lower probability of the stock being overfished (4% vs. 19%).

![Kobe status plot, m1.](https://raw.githubusercontent.com/timjmiller/wham/naa/vignettes/ex5_plots/m1_Kobe_status.png){ width=45% }![Kobe status plot, m8.](https://raw.githubusercontent.com/timjmiller/wham/naa/vignettes/ex5_plots/m8_Kobe_status.png){ width=45% }
