...
This is the 5th WHAM example, which builds off [example 2](https://timjmiller.github.io/wham/articles/ex2_CPI_recruitment.html):
...
We need the same ASAP data file as in [example 2](https://timjmiller.github.io/wham/articles/ex2_CPI_recruitment.html), and the environmental covariate (GSI). Let's copy `ex2_SNEMAYT.dat` and `GSI.csv` to our analysis directory:
```{r eval=FALSE}
wham.dir <- find.package("wham")
...
Model `m11` had $\Delta AIC = 1.5$ and the lowest retrospective pattern for all numbers-at-age and F. Model `m11` left $M_a$ fixed at the values from the ASAP data file (as in `m1`) and estimated 2D AR1 deviations around these mean $M_a$. This is how $M$ was modeled in [Cadigan (2016)](https://www.nrcresearchpress.com/doi/10.1139/cjfas-2015-0047).

![Mohn's rho for SSB, m11.](https://raw.githubusercontent.com/timjmiller/wham/master/vignettes/ex5_plots/m11_SSB_retro_relative.png){ width=45% }![Mohn's rho for F, m11.](https://raw.githubusercontent.com/timjmiller/wham/master/vignettes/ex5_plots/m11_Fbar_retro_relative.png){ width=45% }

![Mohn's rho for recruitment, m11.](https://raw.githubusercontent.com/timjmiller/wham/master/vignettes/ex5_plots/m11_NAA_age1_retro_relative.png){ width=45% }
...
![Relative stock status, m1.](https://raw.githubusercontent.com/timjmiller/wham/master/vignettes/ex5_plots/m1_FSPR_relative.png){ width=31% }![Relative stock status, m8.](https://raw.githubusercontent.com/timjmiller/wham/master/vignettes/ex5_plots/m8_FSPR_relative.png){ width=31% }![Relative stock status, m11.](https://raw.githubusercontent.com/timjmiller/wham/master/vignettes/ex5_plots/m11_FSPR_relative.png){ width=31% }
...
![Reference point variability, m1.](https://raw.githubusercontent.com/timjmiller/wham/master/vignettes/ex5_plots/m1_FSPR_annual_time.png){ width=31% }![Reference point variability, m8.](https://raw.githubusercontent.com/timjmiller/wham/master/vignettes/ex5_plots/m8_FSPR_annual_time.png){ width=31% }![Reference point variability, m11.](https://raw.githubusercontent.com/timjmiller/wham/master/vignettes/ex5_plots/m11_FSPR_annual_time.png){ width=31% }
...
![Kobe status plot, m1.](https://raw.githubusercontent.com/timjmiller/wham/master/vignettes/ex5_plots/m1_Kobe_status.png){ width=31% }![Kobe status plot, m8.](https://raw.githubusercontent.com/timjmiller/wham/master/vignettes/ex5_plots/m8_Kobe_status.png){ width=31% }![Kobe status plot, m11.](https://raw.githubusercontent.com/timjmiller/wham/master/vignettes/ex5_plots/m11_Kobe_status.png){ width=31% }
