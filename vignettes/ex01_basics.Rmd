...
![Example plots in HTML file created by `plot_wham_output(mod=m4, out.type='html')`.](https://raw.githubusercontent.com/timjmiller/wham/master/vignettes/ex1_plots/wham_html_diagnostics.png){ width=100% }
![Example tables HTML file created by `plot_wham_output(mod=m4, out.type='html')`.](https://raw.githubusercontent.com/timjmiller/wham/master/vignettes/ex1_plots/wham_html_tables.png){ width=100% }
...
![Index 2 4-panel](https://raw.githubusercontent.com/timjmiller/wham/master/vignettes/ex1_plots/Index_4panel_index_2_region_1.png){ width=50% }
![Likelihood components](https://raw.githubusercontent.com/timjmiller/wham/master/vignettes/ex1_plots/likelihood.png){ width=50% }

![Conditional expected and posterior estimates of age-1 abundance (recruitment).](https://raw.githubusercontent.com/timjmiller/wham/master/vignettes/ex1_plots/NAA_4panel_stock_1_region_1_age_1.png){ width=50% }
![Conditional expected and posterior estimates of age-5 abundance.](https://raw.githubusercontent.com/timjmiller/wham/master/vignettes/ex1_plots/NAA_4panel_stock_1_region_1_age_5.png){ width=50% }

![Fit to Index 1 age composition data.](https://raw.githubusercontent.com/timjmiller/wham/master/vignettes/ex1_plots/Catch_age_comp_index_1_region_1.png){ width=50% }
![Residuals for Index 1 age composition.](https://raw.githubusercontent.com/timjmiller/wham/master/vignettes/ex1_plots/Catch_age_comp_resids_index_1.png){ width=50% }

![One-step-ahead residuals Fleet 1 catch.](https://raw.githubusercontent.com/timjmiller/wham/master/vignettes/ex1_plots/OSA_resid_catch_4panel_fleet_1.png){ width=33% }
![One-step-ahead residuals Index 1 catch.](https://raw.githubusercontent.com/timjmiller/wham/master/vignettes/ex1_plots/OSA_resid_catch_4panel_index_1.png){ width=33% }
![One-step-ahead residuals Index 2 catch.](https://raw.githubusercontent.com/timjmiller/wham/master/vignettes/ex1_plots/OSA_resid_catch_4panel_index_2.png){ width=33% } 

![One-step-ahead residuals Fleet 1 age composition.](https://raw.githubusercontent.com/timjmiller/wham/master/vignettes/ex1_plots/OSA_resid_paa_6panel_fleet_1.png){ width=33% } 
![One-step-ahead residuals Index 1 age composition.](https://raw.githubusercontent.com/timjmiller/wham/master/vignettes/ex1_plots/OSA_resid_paa_6panel_index_1.png){ width=33% } 
![One-step-ahead residuals Index 2 age composition.](https://raw.githubusercontent.com/timjmiller/wham/master/vignettes/ex1_plots/OSA_resid_paa_6panel_index_2.png){ width=33% }

### Input Data

![Catch](https://raw.githubusercontent.com/timjmiller/wham/master/vignettes/ex1_plots/catch_by_fleet.png){width=50%}
![Indices of abundance](https://raw.githubusercontent.com/timjmiller/wham/master/vignettes/ex1_plots/index.png){width=50%}

### Results

![SSB and F](https://raw.githubusercontent.com/timjmiller/wham/master/vignettes/ex1_plots/SSB_F_trend.png){width=50%}
![Proportion of SSB at age](https://raw.githubusercontent.com/timjmiller/wham/master/vignettes/ex1_plots/SSB_at_age_proportion_stock_1.png){width=50%}

![SSB-Rec on log-scale](https://raw.githubusercontent.com/timjmiller/wham/master/vignettes/ex1_plots/SSB_Rec_loglog_stock_1.png){width=50%}
![Selectivity Fleet 1](https://raw.githubusercontent.com/timjmiller/wham/master/vignettes/ex1_plots/Selectivity_fleet_1_region_1.png){width=50%}

### Reference Points

![Stock status (Kobe plot)](https://raw.githubusercontent.com/timjmiller/wham/master/vignettes/ex1_plots/Kobe_status.png){width=50%}
![Status relative to SPR ](https://raw.githubusercontent.com/timjmiller/wham/master/vignettes/ex1_plots/FSPR_relative.png){width=50%}

### Retrospective

![SSB with 7 peels](https://raw.githubusercontent.com/timjmiller/wham/master/vignettes/ex1_plots/stock_1_SSB_retro.png){width=50%}
![Mohn's rho (SSB) with 7 peels](https://raw.githubusercontent.com/timjmiller/wham/master/vignettes/ex1_plots/stock_1_SSB_retro_relative.png){width=50%}

### Misc

![Catch curves (Fleet 1 observed)](https://raw.githubusercontent.com/timjmiller/wham/master/vignettes/ex1_plots/catch_curves_fleet_1_region_1_obs.png){width=50%}
![Catch at age consistency (Fleet 1 observed)](https://raw.githubusercontent.com/timjmiller/wham/master/vignettes/ex1_plots/catch_at_age_consistency_obs_fleet_1_region_1.png){width=50%}
