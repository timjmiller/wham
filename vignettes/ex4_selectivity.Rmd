...
Here we assume you already have `wham` installed. If not, see the [README](https://github.com/timjmiller/wham#installation-and-basic-use). This is the 4th `wham` example, which builds off model `m4` from [example 1](https://timjmiller.github.io/wham/articles/ex1_SNEMA_yellowtail_flounder.html):
...
We need the same data files as in [example 1](https://timjmiller.github.io/wham/articles/ex1_SNEMA_yellowtail_flounder.html). Let's copy `ex1_SNEMAYT.dat` to our analysis directory:
```{r eval=FALSE}
wham.dir <- find.package("wham")
