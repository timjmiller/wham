...
We need the same data files as in [example 1](https://timjmiller.github.io/wham/articles/ex1_basics.html). Let's copy `ex1_SNEMAYT.dat` to our analysis directory:
```{r eval=FALSE}
wham.dir <- find.package("wham")
...
Check which models converged. Note that 1 of the 9 models did NOT converge:
