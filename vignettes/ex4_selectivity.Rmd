...
`$re` | Deviations from mean | Estimated parameters 
--- | --- | ---
...
![Selectivity-at-age for block 1, all models.](https://raw.githubusercontent.com/timjmiller/wham/selectivity/vignettes/ex4_plots/selAA.png){ width=90% }
