...
- `$mean_model`: Natural mortality model options.
  ...
  - `"estimate-M"`: estimate one or more (mean) $M$ parameters. Default is to estimate a single $M$, shared across all ages and years.
  - `"fixed-M"`: Use initial values from ASAP3 dat files or `$initial_means` for (mean) $M$ as fixed values.
...
thebest <- c(12)
vign5_res$Ecov_how [grep("linear", vign5_res$Ecov_how)] <- "linear"
vign5_res$Ecov_how [grep("poly-2", vign5_res$Ecov_how)] <- "poly-2"
vign5_res |>
  select(!(c(age_specific,mean_model))) |>
  dplyr::rename("Mean model"="M_model", "RE model" = "M_re", "GSI model"="Ecov_process", "GSI link"="Ecov_how",
         "Converged"="conv", "PD Hessian"="pdHess", "Runtime (min)"="runtime",
...
![Natural mortality by age (y-axis) and year (x-axis) for all models.](https://raw.githubusercontent.com/timjmiller/wham/master/vignettes/ex5_plots/MAA.png){ width=100% }
...
![Mohn's rho for numbers-at-age, m1.](https://raw.githubusercontent.com/timjmiller/wham/master/vignettes/ex5_plots/m1_NAA_retro_relative.png){ width=50% }
![Mohn's rho for numbers-at-age, m12.](https://raw.githubusercontent.com/timjmiller/wham/master/vignettes/ex5_plots/m12_NAA_retro_relative.png){ width=50% }

![Mohn's rho for SSB, m1.](https://raw.githubusercontent.com/timjmiller/wham/master/vignettes/ex5_plots/m1_SSB_retro_relative.png){ width=50% }
![Mohn's rho for SSB, m12.](https://raw.githubusercontent.com/timjmiller/wham/master/vignettes/ex5_plots/m12_SSB_retro_relative.png){ width=50% }

![Mohn's rho for F, m1.](https://raw.githubusercontent.com/timjmiller/wham/master/vignettes/ex5_plots/m1_Fbar_retro_relative.png){ width=50% }
![Mohn's rho for F, m12.](https://raw.githubusercontent.com/timjmiller/wham/master/vignettes/ex5_plots/m12_Fbar_retro_relative.png){ width=50% }
...
![Reference point variability, m1.](https://raw.githubusercontent.com/timjmiller/wham/master/vignettes/ex5_plots/m1_FSPR_absolute.png){ width=50% }
![Reference point variability, m12.](https://raw.githubusercontent.com/timjmiller/wham/master/vignettes/ex5_plots/m12_FSPR_absolute.png){ width=50% }

Compared to `m1` (left), `m12` (right) estimated higher *M* and higher SSB -- a much rosier picture of the stock status through time.

![Relative stock status, m1.](https://raw.githubusercontent.com/timjmiller/wham/master/vignettes/ex5_plots/m1_FSPR_relative.png){ width=50% }
![Relative stock status, m12.](https://raw.githubusercontent.com/timjmiller/wham/master/vignettes/ex5_plots/m12_FSPR_relative.png){ width=50% }


In the final year (2011), `m12` estimated much lower probabilities of the stock being overfished than `m1` (1% vs. 93%).

![Kobe status plot, m1.](https://raw.githubusercontent.com/timjmiller/wham/master/vignettes/ex5_plots/m1_Kobe_status.png){ width=50% }
![Kobe status plot, m12.](https://raw.githubusercontent.com/timjmiller/wham/master/vignettes/ex5_plots/m12_Kobe_status.png){ width=50% }
