...
We specify the options for modeling recruitment and any environmental covariate(s) using the `prepare_wham_input` function. WHAM provides 4 options for recruitment (`recruit_model`): 1) random walk, 2) random about mean, 3) Beverton-Holt, and 4) Ricker. 
...
```{r eval=FALSE}
  ...
  Ecov <- list(
    ...
    how = df.mods$Ecov_how[m], # 0 = no effect, 1 = controlling, 2 = limiting, 4 = masking
