...
### Minor improvements
* (2.1.0.9011) added a spawning stock biomass (SSB) table to results generated by `plot_wham_output`. [f57f0e5](https://github.com/timjmiller/wham/commit/f57f0e5e1b638f9d46490ee444e2397542ee4e6a)
* (2.1.0.9011) added exported `aic` function that will also calculate conditional AIC. [4a1e3bb](https://github.com/timjmiller/wham/commit/4a1e3bbebffefefdecf8013dc96b2b6b20dc6bbc)
...
### Bug fixes
* (2.1.0.9011) fix bug in selectivity configuration using `prepare_wham_input`. [823107f](https://github.com/timjmiller/wham/commit/823107fd2dadb1fa6819124fdc3681fe6615c69e)
