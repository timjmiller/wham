...
### Minor improvements
* (2.1.0.9006) added `map_re` element to selectivity options to allow greater flexibility of random effects configuration. [xxxx](https://github.com/timjmiller/wham/commit/xxxx)
...
### Bug fixes
* (2.1.0.9006) fix bug in double logistic bounds configuration using `selectivity$par_min` and `selectiivity$par_max`. [xxxx](https://github.com/timjmiller/wham/commit/xxxx)
* (2.1.0.9006) fix bug in selectivity random effects in retro peels. [xxxx](https://github.com/timjmiller/wham/commit/xxxx)
* (2.1.0.9006) fix OSA residual plots missing from html output. [xxxx](https://github.com/timjmiller/wham/commit/xxxx)
* (2.1.0.9005) fix bugs in example scripts. [35c17a5](https://github.com/timjmiller/wham/commit/35c17a5a2be247940568d47f38cb6e72ce181647)
* (2.1.0.9005) fix bug in `prepare_projections` with options to average NAA deviations, bug in `compare_wham_models` with plotting ASAP models. [23150ef](https://github.com/timjmiller/wham/commit/23150efbd02aefea69000c958d7f3594744017fe)
* (2.1.0.9005) fix bug in plotting of tiled selectivity blocks when they apply to only a subset of years. [f2e441e](https://github.com/timjmiller/wham/commit/f2e441e7d20b97fbf9998053a05db1aeb371759b)
